...
const options = {
  ...
  templates: {
    ...
    <title>Rasel Power Gym</title>\r
    <link rel="preconnect" href="https://fonts.googleapis.com" />\r
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />\r
    <link\r
      href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;500;600;700&display=swap"\r
      rel="stylesheet"\r
    />\r
    <link\r
      rel="stylesheet"\r
      href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"\r
    />\r
    ...
    <style>\r
      .hero-gradient {\r
        background: linear-gradient(135deg, #0a0a0a 0%, #1a0505 100%);\r
      }\r
      @keyframes fade-in {\r
        from {\r
          opacity: 0;\r
      ...
      @keyframes slide-in-from-left {\r
        from {\r
          transform: translateX(-50px);\r
          opacity: 0;\r
        }\r
        to {\r
      ...
      @keyframes slide-in-from-bottom-10 {\r
        from {\r
      ...
      .slide-in-from-left {\r
        animation-name: slide-in-from-left;\r
      }\r
      .zoom-in {\r
        animation-name: zoom-in;\r
      }\r
      .slide-in-from-bottom-10 {\r
        animation-name: slide-in-from-bottom-10;\r
      }\r
      .duration-1000 {\r
      ...
      .outline-text {\r
        -webkit-text-stroke: 1px white;\r
        text-stroke: 1px white;\r
      }\r
      body {\r
        margin: 0;\r
        padding: 0;\r
