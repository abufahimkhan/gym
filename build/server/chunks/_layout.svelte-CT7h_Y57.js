...
import { L as LOCATION, C as CONTACT_PHONE, M as MAP_LINK } from './constants-DEYMn8FU.js';
...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<nav${attr_class(`fixed w-full z-50 transition-all duration-300 ${isScrolled ? "bg-black/90 py-3 backdrop-blur-md border-b border-white/10" : "bg-transparent py-5"}`)}><div class="container mx-auto px-6 flex justify-between items-center"><div class="flex items-center gap-2"><div class="w-10 h-10 bg-red-600 flex items-center justify-center rounded-lg shadow-lg shadow-red-600/20"><i class="fas fa-bolt text-white text-xl"></i></div> <span class="text-2xl font-oswald font-bold tracking-tighter text-white uppercase italic">USA <span class="text-red-600">Power</span> <span class="text-red-600">Gym</span></span></div> <div class="hidden md:flex items-center space-x-8"><!--[-->`);
...
//# sourceMappingURL=_layout.svelte-CT7h_Y57.js.map
