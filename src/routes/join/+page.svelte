    ...
    {#if !submitted}
      <div class="text-center mb-12">
        ...
        <h1 class="text-5xl md:text-6xl font-oswald font-bold uppercase italic mb-6">
          Join <span class="text-red-600">Rasel Power</span>
        </h1>
        <p class="text-gray-400 max-w-2xl mx-auto">
          Fill out the form below to become part of Khulna's most elite fitness community. Transform your body, mind, and life.
        </p>
      </div>
    ...
    {:else}
      ...
      <div class="text-center py-16">
        ...
        <h2 class="text-4xl md:text-5xl font-oswald font-bold uppercase italic mb-4">
          Welcome to <span class="text-red-600">Rasel Power</span>!
        </h2>
